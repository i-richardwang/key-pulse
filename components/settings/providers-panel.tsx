...
export function ProvidersPanel() {
  ...
  const [editProvider, setEditProvider] = useState<ProviderWithDetails | null>(null);
  const [deleteDialogOpen, setDeleteDialogOpen] = useState(false);
  const [deleteTarget, setDeleteTarget] = useState<ProviderWithDetails | null>(null);
  ...
  const handleEdit = (provider: ProviderWithDetails) => {
    setEditProvider(provider);
    setDialogOpen(true);
  };

  const handleDeleteClick = (provider: ProviderWithDetails) => {
